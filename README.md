# Setup P5JS :
	...
	3. Create a HTML file and import P5JS in the <header></header> using <script src="YourP5JSSource.js"></script>
		2.1 Use a local file such as : <script src="../p5.min.js"></script>
		2.2 Or use a hosted online version stored in CDN (Content Delivery Network). See all verson at : https://cdnjs.com/libraries/p5.js. Import using : <script src="//cdnjs.cloudflare.com/ajax/libs/p5.js/0.5.6/p5.js"></script>
	...
	6. Find exemples or ressources 
		p5js.org
		hello.p5js.org/
		openProcessing.org
		https://www.youtube.com/channel/UCvjgXvBlbQiydffZU7m1_aw

	7. Find all ressource from the first semester : https://github.com/alexr4/e-artsup-GxD_Semestre1;
